...
public class CannyEdgeDetector {
    ...
    public static BufferedImage convertToEdgeView(BufferedImage bufferedImage) {
        ...
        processedImage.convertYellowsToWhite();
    ...
    private static void convertToGrayScale(PLImage img){
    ...
    private static void applyGaussianFilter(PLImage img){
    ...
    private static void findIntensityGradient(PLImage img){
    ...
    private static void applyNonMaximumSuppression(PLImage img){
    ...
    private static void applyDoubleThreshold(PLImage img){
