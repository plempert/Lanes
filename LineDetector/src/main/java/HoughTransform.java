...
public class HoughTransform {
    ...
    private static int r_max;
    private static int t_max = 180;

    private static class SetIndexBoundArray{
    ...
    private static SetIndexBoundArray fillAccumulator(PLImage img){
        SetIndexBoundArray accum;
    ...
    public static ArrayList<Line> findLines(BufferedImage bufferedImage){
        ArrayList<Line> lines = new ArrayList<Line>();
        PLImage img = new PLImage(bufferedImage);
        SetIndexBoundArray accum = fillAccumulator(img);
...
//        }
    ...
    private static void drawLine(PLImage img, Line l){
    ...
    public static BufferedImage drawLines(BufferedImage img, ArrayList<Line> lines){
